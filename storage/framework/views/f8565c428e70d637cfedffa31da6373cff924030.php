          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="col-md-3">
                  <a href="<?php echo e(URL::to('admin/movies/add_movie')); ?>" class="btn btn-success btn-md waves-effect waves-light m-b-20" data-toggle="tooltip" title="<?php echo e(trans('words.add_originals')); ?>"><i class="fa fa-plus"></i> <?php echo e(trans('words.add_original')); ?></a>
                </div>
              </div>
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th><?php echo e(trans('words.poster')); ?></th>
                      <th><?php echo e(trans('words.access')); ?></th>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\video_script_new\resources\views/admin/pages/movies_list.blade.php ENDPATH**/ ?>