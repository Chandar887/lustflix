          ...
          <div class="vfx_video_item">
            <div class="vfx_upcomming_item_block"> 
              <?php if($watched_videos->video_type=="Movies"): ?>
                <a href="<?php echo e(URL::to('originals/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->video_slug.'/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->id)); ?>">
              ...
              <?php if($watched_videos->video_type=="Sports"): ?>
                <a href="<?php echo e(URL::to('short-films/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->video_slug.'/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->id)); ?>">
              ...
              <?php if($watched_videos->video_type=="LiveTV"): ?>
                <a href="<?php echo e(URL::to('regional/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->channel_slug.'/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->id)); ?>">
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\video_script_new\resources\views/pages/index.blade.php ENDPATH**/ ?>