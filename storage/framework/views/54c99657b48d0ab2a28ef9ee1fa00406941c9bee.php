 ...
 <div class="main-wrap">
  <div class="section section-padding tv_show vfx_video_list_section text-white">
    <div class="container">
      ...
      <?php if(Auth::check()): ?>              
          <a class="icon" href="<?php echo e(URL::to('originals/'.$movies_data->video_slug.'/'.$movies_data->id)); ?>"> 
      <?php else: ?>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6">
          ...
          <i class="icon fa fa-play"></i><span class="ripple"></span>
              ...
              <div class="vfx_video_detail">
                <h4 class="vfx_video_title"><a href="<?php echo e(URL::to('originals/'.$movies_data->video_slug.'/'.$movies_data->id)); ?>"><?php echo e(Str::limit(stripslashes($movies_data->video_title),12)); ?></a></h4>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\video_script_new\resources\views/pages/movies.blade.php ENDPATH**/ ?>