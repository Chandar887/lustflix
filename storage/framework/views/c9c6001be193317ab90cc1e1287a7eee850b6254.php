            ...
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                     ...
                     <div class="col-sm-6">
                        <a href="<?php echo e(URL::to('regional/'.$tv_info->channel_slug.'/'.$tv_info->id)); ?>" target="_blank"><h4 class="header-title m-t-0 m-b-30 text-primary pull-right" style="font-size: 20px;"><?php echo e(trans('words.preview')); ?> <i class="fa fa-eye"></i></h4> </a>
                     </div>
                     <?php endif; ?>
                   </div>
                ...
                <?php endif; ?>
                 ...
                 <?php echo Form::open(array('url' => array('admin/live_tv/add_edit_live_tv'),'class'=>'form-horizontal','name'=>'video_form','id'=>'video_form','role'=>'form','enctype' => 'multipart/form-data')); ?>  
                  ...
                  <div class="col-md-6">
                    <h4 class="m-t-0 m-b-30 header-title" style="font-size: 20px;"><?php echo e(trans('words.regional_info')); ?></h4> 

                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.regional_access')); ?></label>
                      <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.regional_category')); ?>*</label>
                      <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.regional_name')); ?>*</label>
                    <div class="col-sm-8">
                ...
                <div class="col-md-6">
                    ...
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.live_tv_stream_type')); ?> </label>
                      <div class="col-sm-8">
                            ...
                            <option value="local" <?php if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type=="local"): ?> selected <?php endif; ?>>Local</option>
                            ...
                            <!-- <option value="hls" <?php if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type=="hls"): ?> selected <?php endif; ?>>HLS/M3U8/HTTP</option> -->
                                <option value="dash" <?php if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type=="dash"): ?> selected <?php endif; ?>>MPEG-DASH</option>
                ...
                <div class="form-group row" id="local_url_id" <?php if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type!="local"): ?> style="display:none;" <?php endif; ?>>
                  <label class="col-sm-3 col-form-label"><?php echo e(trans('words.video_file')); ?>*</label>
                  <div class="col-sm-8">
                      <div class="input-group">

                        <input type="text" name="channel_url_local" id="local_channel" value="<?php echo e(isset($tv_info->channel_url) ? $tv_info->channel_url : null); ?>" class="form-control" readonly>
                  ...
                  <!-- <div class="form-group row" id="live_url_id" <?php if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type!="hls"): ?> style="display:none;" <?php endif; ?>>
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.server_1_url')); ?>*</label>
                     <div class="col-sm-8">
                      <input type="text" name="channel_url" value="<?php echo e(isset($tv_info->channel_url) ? $tv_info->channel_url : null); ?>" class="form-control">
                    </div><br/><br/>
                    
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.server_2_url')); ?></label>
                     <div class="col-sm-8">
                      <input type="text" name="channel_url2" value="<?php echo e(isset($tv_info->channel_url2) ? $tv_info->channel_url2 : null); ?>" class="form-control">
                    </div><br/><br/>

                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.server_3_url')); ?></label>
                     <div class="col-sm-8">
                      <input type="text" name="channel_url3" value="<?php echo e(isset($tv_info->channel_url3) ? $tv_info->channel_url3 : null); ?>" class="form-control">
                    </div>

                  </div> -->
                  <div class="form-group row" id="live_url_dash_id" <?php if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type!="dash"): ?> style="display:none;" <?php endif; ?> <?php if(!isset($tv_info->channel_url_type)): ?> style="display:none;" <?php endif; ?>>
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.server_1_url')); ?>*</label>
                     <div class="col-sm-8">
                      <input type="text" name="channel_url_dash" value="<?php echo e(isset($tv_info->channel_url) ? $tv_info->channel_url : null); ?>" class="form-control">
                    </div><br/><br/>
                    
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.server_2_url')); ?></label>
                     <div class="col-sm-8">
                      <input type="text" name="channel_url2_dash" value="<?php echo e(isset($tv_info->channel_url2) ? $tv_info->channel_url2 : null); ?>" class="form-control">
                    </div><br/><br/>

                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.server_3_url')); ?></label>
                     <div class="col-sm-8">
                      <input type="text" name="channel_url3_dash" value="<?php echo e(isset($tv_info->channel_url3) ? $tv_info->channel_url3 : null); ?>" class="form-control">
                    </div>

                  </div>
                  <div class="form-group row" id="channel_url_youtube_id" <?php if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type!="youtube"): ?> style="display:none;" <?php endif; ?> <?php if(!isset($tv_info->channel_url_type)): ?> style="display:none;" <?php endif; ?>>

                      <label class="col-sm-3 col-form-label"><?php echo e(trans('words.youtube_url')); ?>*</label>
                     <div class="col-sm-8">
                      <input type="text" name="channel_url_youtube" value="<?php echo e(isset($tv_info->channel_url) ? $tv_info->channel_url : null); ?>" class="form-control">
                    </div><br/><br/>

                  </div>  
                  <div class="form-group row" id="live_embed_id" <?php if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type!="embed"): ?> style="display:none;" <?php endif; ?> <?php if(!isset($tv_info->channel_url_type)): ?> style="display:none;" <?php endif; ?>>
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.embed_code')); ?>*</label>
                     <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-8">                         
                        ...
                        <p id="dash_stream_id" <?php if(!isset($tv_info->channel_url_type)): ?> style="display:none;" <?php endif; ?> <?php if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type!="dash"): ?> style="display:none;" <?php endif; ?>><small id="emailHelp" class="form-text text-muted">Supported MPD URL </small></p>
                        ...
                        <p id="local_stream_id" <?php if(!isset($tv_info->channel_url_type)): ?> style="display:none;" <?php endif; ?> <?php if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type!="local"): ?> style="display:none;" <?php endif; ?>><small id="emailHelp" class="form-text text-muted">Supported Local Video </small></p>
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.regional_logo')); ?>* <small id="emailHelp" class="form-text text-muted">(<?php echo e(trans('words.recommended_resolution')); ?> : 650x350)</small></label>
                    <div class="col-sm-8">
                      <div class="input-group">
    ...
    <div class="modal-dialog modal-lg" style="max-width: 900px;">
        <div class="modal-content">             
            <div class="modal-body">
               ...
               <iframe src="<?php echo e(URL::to('responsive_filemanager/filemanager/dialog.php?type=2&sort_by=date&field_id=local_channel&relative_url=1')); ?>" frameborder="0"></iframe>
               </div>
            </div>
        </div> 
    </div> 
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\video_script_new\resources\views/admin/pages/addeditlivetv.blade.php ENDPATH**/ ?>