 ...
 <div class="main-wrap">
  <div class="section section-padding tv_show vfx_video_list_section text-white">
    <div class="container">
      ...
      <?php if(Auth::check()): ?>              
          <a class="icon" href="<?php echo e(URL::to('short-films/'.$sports_video->video_slug.'/'.$sports_video->id)); ?>">
      <?php else: ?>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\video_script_new\resources\views/pages/sports.blade.php ENDPATH**/ ?>