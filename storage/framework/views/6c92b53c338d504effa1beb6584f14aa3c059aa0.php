  ...
  <div id="vfx_banner_slider" class="owl-carousel vfx_banner_slider">
    ...
    <div class="banner-item" style="background-image:url(<?php echo e(URL::to('upload/source/'.$slider_data->slider_image)); ?>);">
      <div class="overlay-70"> 
        ...
        <a class="" href="<?php echo e(URL::to('originals/'.App\Movies::getMoviesInfo($slider_data->slider_post_id,'video_slug').'/'.$slider_data->slider_post_id)); ?>">
        ...
        <a class="" href="<?php echo e(URL::to('short-films/'.App\Sports::getSportsInfo($slider_data->slider_post_id,'video_slug').'/'.$slider_data->slider_post_id)); ?>">
            <i class="icon fa fa-play"></i><span class="ripple"></span>
        </a>
        <?php elseif($slider_data->slider_type=="LiveTV"): ?>
        <a class="" href="<?php echo e(URL::to('regional/'.App\LiveTV::getLiveTvInfo($slider_data->slider_post_id,'channel_slug').'/'.$slider_data->slider_post_id)); ?>">
            <i class="icon fa fa-play"></i><span class="ripple"></span>
        </a>  
        <?php else: ?>
          <a class="" href="#">
  ...
  <div class="prs_upcom_slider_main_wrapper">
    ...
    <div class="wrap-album-slider wrap-album-slider-top-slider">
          ...
          <?php $__currentLoopData = $recently_watched; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$watched_videos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="album-slider__item" style="height:100%">
              <figure class="album">
                  ...
                  <div class="prs_upcom_movie_img_box">
                     <?php if($watched_videos->video_type=="Movies"): ?>
                        ...
                        <div class="prs_upcom_movie_img_btn_wrapper">
                          <ul>
															<li><a href="<?php echo e(URL::to('originals/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->video_slug.'/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->id)); ?>">View Video</a>
															</li>
                        ...
                        <?php if($watched_videos->video_type=="Sports"): ?>
													...
													<div class="prs_upcom_movie_img_btn_wrapper">
														<ul>
															<li><a href="<?php echo e(URL::to('short-films/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->video_slug.'/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->id)); ?>">View Video</a>
															</li>
															<!-- <li><a href="#">View Details</a> -->
															</li>
														</ul>
                        ...
                        <?php if($watched_videos->video_type=="Episodes"): ?>
                           <?php $episode_series_id=\App\Episodes::getEpisodesInfo($watched_videos->video_id,'episode_series_id');?>
													...
													<div class="prs_upcom_movie_img_btn_wrapper">
														<ul>
															<li><a href="<?php echo e(URL::to('series/'.\App\Series::getSeriesInfo($episode_series_id,'series_slug').'/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->video_slug.'/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->id)); ?>">View Video</a>
															</li>
															<!-- <li><a href="#">View Details</a> -->
															</li>
														</ul>
                        ...
                        <?php if($watched_videos->video_type=="LiveTV"): ?>
													...
													<div class="prs_upcom_movie_img_btn_wrapper">
														<ul>
															<li><a href="<?php echo e(URL::to('regional/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->channel_slug.'/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->id)); ?>">View Video</a>
															</li>
															<!-- <li><a href="#">View Details</a> -->
															</li>
														</ul>
  ...
  <div class="prs_upcom_slider_main_wrapper">
        ...
        <div class="prs_upcom_slider_slides_wrapper">
                 ...
                 <?php $__currentLoopData = explode(",",$home_sections->section1_latest_movie); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $latest_movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>            
                            ...
                            <?php if(Auth::check()): ?>  
                                <a  href="<?php echo e(URL::to('originals/'.App\Movies::getMoviesInfo($latest_movie,'video_slug').'/'.App\Movies::getMoviesInfo($latest_movie,'id'))); ?>">View Originals</a>
                                <?php else: ?>
                                  <?php if(App\Movies::getMoviesInfo($latest_movie,'video_access')=='Paid'): ?>
                                    <a  href="Javascript::void();" >
                                  <?php else: ?>
                                    <a  href="<?php echo e(URL::to('originals/'.App\Movies::getMoviesInfo($latest_movie,'video_slug').'/'.App\Movies::getMoviesInfo($latest_movie,'id'))); ?>">
                              <?php endif; ?>  
                            <?php endif; ?>
                                </li>
																<!-- <li><a href="#">View Details</a> -->
        ...
        <div class="prs_upcom_slider_slides_wrapper">
                 ...
                 <?php if(App\Series::getSeriesInfo($latest_series,'status')==1): ?>
											...
											<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-sm hidden-xs">
												<div class="prs_upcom_movie_box_wrapper">
													<div class="prs_upcom_movie_img_box">
														<img src="<?php echo e(URL::to('upload/source/'.App\Series::getSeriesInfo($latest_series,'series_poster'))); ?>" alt="movie_img" />
														<div class="prs_upcom_movie_img_overlay"></div>
														<div class="prs_upcom_movie_img_btn_wrapper">
															<ul>
																<li>
                                ...
                                <a  href="<?php echo e(URL::to('series/'.App\Series::getSeriesInfo($latest_series,'series_slug').'/'.App\Series::getSeriesInfo($latest_series,'id'))); ?>">View Series</a>
      ...
      <div class="row">
        <div class="col-sm-12 col-xs-6">
          <div class="vfx_section_header">
            ...
            <h2 class="vfx_section_title"><a href="<?php echo e(URL::to('/originals')); ?>"><?php echo e(trans('words.original')); ?></a></h2>
          </div>
        </div>        
      </div>
      <div class="row">
        <div class="owl-carousel video-carousel" id="video-carousel">
          ...
          <?php $__currentLoopData = explode(",",$home_sections->section1_latest_movie); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $latest_movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>            
            ...
            <?php if(Auth::check()): ?>              
                <a class="icon" href="<?php echo e(URL::to('originals/'.App\Movies::getMoviesInfo($latest_movie,'video_slug').'/'.App\Movies::getMoviesInfo($latest_movie,'id'))); ?>">              
            <?php else: ?>
               <?php if(App\Movies::getMoviesInfo($latest_movie,'video_access')=='Paid'): ?>
      ...
      <div class="row">
        <div class="col-sm-12 col-xs-6">
          <div class="vfx_section_header">
            ...
            <h2 class="vfx_section_title"><a href="<?php echo e(URL::to('series/latest')); ?>"><?php echo e(trans('words.webseries')); ?></a></h2>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-xs-6">
          <div class="vfx_section_header">
            <!-- <h2 class="vfx_section_title"><a href="<?php echo e(URL::to('movies/latest')); ?>"><?php echo e(trans('words.latest_movies')); ?></a></h2> -->
            <h2 class="vfx_section_title"><a href="<?php echo e(URL::to('/short-films')); ?>"><?php echo e(trans('words.short_films')); ?></a></h2>
          </div>
        </div>        
      </div>
      <div class="row">
        <div class="owl-carousel video-carousel" id="video-carousel">
          ...
          <?php $__currentLoopData = explode(",",$home_sections->section6_short_films); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $short_films): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>            
            ...
            <?php if(Auth::check()): ?>              
                <a class="icon" href="<?php echo e(URL::to('short-films/'.App\Sports::getSportsInfo($short_films,'video_slug').'/'.App\Sports::getSportsInfo($short_films,'id'))); ?>">              
            <?php else: ?>
            ...
            <div class="vfx_video_item">
              <div class="thumb-wrap"> <img src="<?php echo e(URL::to('upload/source/'.App\Sports::getSportsInfo($short_films,'video_image'))); ?>" alt="Movie Thumb"> <?php if(App\Sports::getSportsInfo($short_films,'video_access')=='Paid'): ?><span class="premium_video"><i class="fa fa-lock"></i>Premium</span><?php endif; ?>
                <div class="thumb-hover">            
            <i class="icon fa fa-play"></i><span class="ripple"></span>
              ...
              <div class="vfx_video_detail">
                <h4 class="vfx_video_title"><?php echo e(Str::limit(stripslashes(App\Sports::getSportsInfo($short_films,'video_title')),12)); ?></h4>
                <p class="vfx_video_length"><i class="fa fa-clock-o"></i> <?php echo e(App\Sports::getSportsInfo($short_films,'duration')); ?></p>
               </div>
            </div>
           </a> 
            <?php endif; ?>
  ...
  <div class="section section-padding bg-image tv_show gray_bg">
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-xs-6">
          <div class="vfx_section_header">
            <h2 class="vfx_section_title"><a href="<?php echo e(URL::to('/regional')); ?>"><?php echo e(trans('words.regional')); ?></a></h2>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <?php $__currentLoopData = explode(",",$home_sections->section7_regional); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $regional): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>            
          <?php if(App\LiveTV::getLiveTvInfo($regional,'status')==1): ?>
            ...
            <a href="<?php echo e(URL::to('regional/'.App\LiveTV::getLiveTvInfo($regional,'channel_slug').'/'.App\LiveTv::getLiveTvInfo($regional,'id'))); ?>">
            <div class="vfx_video_item">
             <div class="vfx_upcomming_item_block"> 
              <img class="img-responsive" src="<?php echo e(URL::to('upload/source/'.App\LiveTV::getLiveTvInfo($regional,'channel_thumb'))); ?>" alt="show">                            
             </div>                  
			 <div class="vfx_upcomming_detail">
			  <h4 class="vfx_video_title"><?php echo e(Str::limit(stripslashes(App\LiveTV::getLiveTvInfo($regional,'channel_name')),25)); ?></h4>
			 </div> 
           </div>
           </a>  
          <?php endif; ?>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kiwitv_updated\resources\views/pages/index.blade.php ENDPATH**/ ?>