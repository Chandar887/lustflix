        ...
        <div class="row">
          <div class="col-xs-12">            
            ...
            <?php if($tv_info->channel_url_type=="embed"): ?>
              ...
              <?php elseif($tv_info->channel_url_type=="local"): ?>
              <div id="container">                   
              <video id="v_player" class="video-js vjs-big-play-centered skin-blue vjs-16-9" controls preload="auto" playsinline crossorigin="anonymous" width="640" height="450" poster="<?php echo e(URL::to('upload/source/'.$tv_info->channel_thumb)); ?>" data-setup="{}" <?php if(get_player_cong('autoplay')=="true"): ?>autoplay="true"<?php endif; ?>>
                  ...
                  <source src="<?php echo e('upload/source/'.$tv_info->channel_url2); ?>"   type="video/mp4" /> 
                  <?php elseif(isset($_GET['server']) AND $_GET['server']==3): ?>
                  <source src="<?php echo e('upload/source/'.$tv_info->channel_url3); ?>"   type="video/mp4" /> 
                  <?php else: ?>
                  <source src="<?php echo e(URL::to('upload/source/'.$tv_info->channel_url)); ?>"  type="video/mp4" /> 
            ...
            <?php elseif($tv_info->channel_url_type=="hls"): ?>
              ...
              <video id="v_player" class="video-js vjs-big-play-centered skin-blue vjs-16-9" controls preload="auto" playsinline crossorigin="anonymous" width="640" height="450" poster="<?php echo e(URL::to('upload/source/'.$tv_info->channel_thumb)); ?>" data-setup="{}" <?php if(get_player_cong('autoplay')=="true"): ?>autoplay="true"<?php endif; ?>>
                  ...
                  <!-- video source -->
                  <?php if(isset($_GET['server']) AND $_GET['server']==2): ?>
                  <source src="<?php echo e($tv_info->channel_url2); ?>" type="application/x-mpegURL"  type="video/mp4" / > 
                  <?php elseif(isset($_GET['server']) AND $_GET['server']==3): ?>
                  <source src="<?php echo e($tv_info->channel_url3); ?>" type="application/x-mpegURL"  type="video/mp4" /> 
                  <?php else: ?>
                  <source src="<?php echo e($tv_info->channel_url); ?>" type="application/x-mpegURL" type="video/mp4" /> 
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\kiwitv\resources\views/pages/livetv_single.blade.php ENDPATH**/ ?>