<div class="left side-menu">
      <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
          ...
          <ul>
            ...
            <li><a href="<?php echo e(URL::to('admin/originals')); ?>" class="waves-effect <?php echo e(classActivePath('movies')); ?>"><i class="fa fa-video-camera"></i> <span> <?php echo e(trans('words.original')); ?></span></a></li>
            <?php 
            ...
            ?>
            <li class="has_sub"> 
              <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-film"></i><span><?php echo e(trans('words.series')); ?> </span> <span class="menu-arrow"></span></a>
            ...
            <li class="has_sub"> 
              <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-tv"></i><span><?php echo e(trans('words.short_films')); ?> </span> <span class="menu-arrow"></span></a>
              <ul class="list-unstyled">                 
                <li class="<?php echo e(classActivePath('sports_category')); ?>"><a href="<?php echo e(URL::to('admin/short_film_category')); ?>" class="<?php echo e(classActivePath('sports_category')); ?>"><i class="fa fa-tags"></i> <span> <?php echo e(trans('words.short_films_cat')); ?></span></a></li>
                <li class="<?php echo e(classActivePath('sports')); ?>"><a href="<?php echo e(URL::to('admin/short_film')); ?>" class="<?php echo e(classActivePath('sports')); ?>"><i class="fa fa-list"></i> <span> <?php echo e(trans('words.short_films_vid')); ?></span></a></li>
               </ul>
            </li>
            <li class="has_sub"> 
              <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-globe"></i><span><?php echo e(trans('words.regional')); ?></span> <span class="menu-arrow"></span></a>
              <ul class="list-unstyled">                 
                <li class="<?php echo e(classActivePath('tv_category')); ?>"><a href="<?php echo e(URL::to('admin/regional_category')); ?>" class="<?php echo e(classActivePath('tv_category')); ?>"><i class="fa fa-tags"></i> <span> <?php echo e(trans('words.regional_cat')); ?></span></a></li>
                <li class="<?php echo e(classActivePath('live_tv')); ?>"><a href="<?php echo e(URL::to('admin/regional')); ?>" class="<?php echo e(classActivePath('live_tv')); ?>"><i class="fa fa-list"></i> <span> <?php echo e(trans('words.regional_vid')); ?></span></a></li>
               </ul>
            </li>
            ...
            <li><a href="<?php echo e(URL::to('admin/originals')); ?>" class="waves-effect <?php echo e(classActivePath('movies')); ?>"><i class="fa fa-video-camera"></i> <span> <?php echo e(trans('words.movies_text')); ?></span></a></li>
            <?php 
             // echo classActivePathSub('episodes');
             // exit;
    ...
    </div><?php /**PATH C:\xampp\htdocs\video_script_new\resources\views/admin/sidebar.blade.php ENDPATH**/ ?>