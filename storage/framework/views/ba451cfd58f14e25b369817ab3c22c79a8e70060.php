                ...
                <?php endif; ?>
                 ...
                 <?php echo Form::open(array('url' => array('admin/slider/add_edit_slider'),'class'=>'form-horizontal','name'=>'slider_form','id'=>'slider_form','role'=>'form','enctype' => 'multipart/form-data')); ?>  
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="slider_title" value="<?php echo e(isset($slider_info->slider_title) ? stripslashes($slider_info->slider_title) : null); ?>" class="form-control">
                    </div>
                  </div>
                    ...
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.post_type')); ?></label>
                      <div class="col-sm-8">
                            <select class="form-control" name="slider_type" id="slider_type">    
                                ...
                                <option value="Movies" <?php if(isset($slider_info->id) && $slider_info->slider_type=="Movies"): ?> selected <?php endif; ?>><?php echo e(trans('words.original')); ?></option>
                                <option value="Shows" <?php if(isset($slider_info->id) && $slider_info->slider_type=="Shows"): ?> selected <?php endif; ?>><?php echo e(trans('words.webseries')); ?></option>
                                <option value="Sports" <?php if(isset($slider_info->id) && $slider_info->slider_type=="Sports"): ?> selected <?php endif; ?>><?php echo e(trans('words.short_films')); ?></option>
                                <option value="LiveTV" <?php if(isset($slider_info->id) && $slider_info->slider_type=="LiveTV"): ?> selected <?php endif; ?>><?php echo e(trans('words.regional')); ?></option>
                  ...
                  <div class="form-group row" id="movie_list_id" <?php if(isset($slider_info->id) && $slider_info->slider_type!="Movies"): ?> style="display: none;" <?php endif; ?> <?php if(!isset($slider_info->id)): ?> style="display: none;" <?php endif; ?>>
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.original')); ?></label>
                      <div class="col-sm-8">
                            <select class="form-control select2" name="movie_id" id="movie_id">    
                                <option value=""> <?php echo e(trans('words.select_original')); ?> </option>                            
                  ...
                  <div class="form-group row" id="show_list_id" <?php if(isset($slider_info->id) && $slider_info->slider_type!="Shows"): ?> style="display: none;" <?php endif; ?> <?php if(!isset($slider_info->id)): ?> style="display: none;" <?php endif; ?>>
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.webseries')); ?></label>
                      <div class="col-sm-8">
                            <select class="form-control select2" name="series_id" id="series_id">    
                                <option value=""> <?php echo e(trans('words.select_webseries')); ?> </option>                            
                  ...
                  <div class="form-group row" id="sports_list_id" <?php if(isset($slider_info->id) && $slider_info->slider_type!="Sports"): ?> style="display: none;" <?php endif; ?> <?php if(!isset($slider_info->id)): ?> style="display: none;" <?php endif; ?>>
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.short_films')); ?></label>
                      <div class="col-sm-8">
                            <select class="form-control select2" name="sport_id" id="sport_id">    
                                <option value=""> <?php echo e(trans('words.select_short_films')); ?> </option>                            
                  ...
                  <div class="form-group row" id="live_tv_list_id" <?php if(isset($slider_info->id) && $slider_info->slider_type!="LiveTV"): ?> style="display: none;" <?php endif; ?> <?php if(!isset($slider_info->id)): ?> style="display: none;" <?php endif; ?>>
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.regional')); ?></label>
                      <div class="col-sm-8">
                            <select class="form-control select2" name="live_tv_id" id="live_tv_id">    
                                <option value=""> <?php echo e(trans('words.select_regional')); ?> </option>                            
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kiwitv_updated\resources\views/admin/pages/addeditslider.blade.php ENDPATH**/ ?>