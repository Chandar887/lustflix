          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                     <div class="col-sm-6">
                          <a href="<?php echo e(URL::to('admin/short_film')); ?>"><h4 class="header-title m-t-0 m-b-30 text-primary pull-left" style="font-size: 20px;"><i class="fa fa-arrow-left"></i> <?php echo e(trans('words.back')); ?></h4></a>
                     </div>
                     <?php if(isset($video_info->id)): ?>
                     <div class="col-sm-6">
                        <a href="<?php echo e(URL::to('short-films/'.$video_info->video_slug.'/'.$video_info->id)); ?>" target="_blank"><h4 class="header-title m-t-0 m-b-30 text-primary pull-right" style="font-size: 20px;"><?php echo e(trans('words.preview')); ?> <i class="fa fa-eye"></i></h4> </a>
                     </div>
                     <?php endif; ?>
                   </div>
                ...
                <?php endif; ?>
                 ...
                 <?php echo Form::open(array('url' => array('admin/sports/add_edit_video'),'class'=>'form-horizontal','name'=>'video_form','id'=>'video_form','role'=>'form','enctype' => 'multipart/form-data')); ?>  
                  ...
                  <div class="col-md-6">
                    <h4 class="m-t-0 m-b-30 header-title" style="font-size: 20px;"><?php echo e(trans('words.short_film_info')); ?></h4> 

                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.short_film_access')); ?></label>
                      <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.short_film_cat')); ?></label>
                      <div class="col-sm-8">
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\video_script_new\resources\views/admin/pages/addeditsportsvideo.blade.php ENDPATH**/ ?>