<?php $__env->startSection('head_title', $tv_cat_info->category_name.' '.trans('words.regional').' | '.getcong('site_name') ); ?>
 ...
 <div class="main-wrap">
  <div class="section section-padding tv_show vfx_video_list_section text-white">
    <div class="container">
      ...
      <?php if(Auth::check()): ?>              
          <a class="icon" href="<?php echo e(URL::to('regional/'.$live_tv_data->channel_slug.'/'.$live_tv_data->id)); ?>">
      <?php else: ?>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kiwitv_updated\resources\views/pages/livetv_by_category.blade.php ENDPATH**/ ?>