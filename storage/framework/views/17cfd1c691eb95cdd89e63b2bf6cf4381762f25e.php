<footer class="text-white">
  <div class="vfx_footer_widget">
    ...
    <div class="col-md-4 col-sm-4 col-xs-12">
        ...
        <h3 class="vfx_widget_title text-white"><?php echo e(trans('words.connect_with_us')); ?></h3>   
            <div class="vfx_inner_widget">       
         ...
         <div class="col-md-3 col-sm-4 col-xs-12">
          <div class="widget app-widget vfx_last_widget">
            <h3 class="vfx_widget_title text-white"><?php echo e(trans('words.apps_text')); ?></h3>
            <div class="vfx_inner_widget mr_top"> <a class="google-play-download" href="<?php echo e(stripslashes(getcong('footer_google_play_link'))); ?>" target="_blank"><img src="<?php echo e(URL::asset('site_assets/images/icons/google-play.png')); ?>" alt="Google Play Download"></a> 
            <!-- <a class="apple-store-download" href="<?php echo e(stripslashes(getcong('footer_apple_store_link'))); ?>" target="_blank"><img src="<?php echo e(URL::asset('site_assets/images/icons/app-store.png')); ?>" alt="Apple Store Download"></a> -->
             </div>
          </div>
        </div>
      </div>
...
</footer><?php /**PATH C:\wamp64\www\kiwitv\resources\views/_particles/footer.blade.php ENDPATH**/ ?>