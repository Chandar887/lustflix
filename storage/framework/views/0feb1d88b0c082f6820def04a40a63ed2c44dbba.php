          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="col-md-3">
                  <a href="<?php echo e(URL::to('admin/sports/add_video')); ?>" class="btn btn-success btn-md waves-effect waves-light m-b-20" data-toggle="tooltip" title="<?php echo e(trans('words.add_short_film')); ?>"><i class="fa fa-plus"></i> <?php echo e(trans('words.add_short_film')); ?></a>
                </div>
              </div>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\video_script_new\resources\views/admin/pages/sports_video_list.blade.php ENDPATH**/ ?>