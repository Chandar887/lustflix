...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
	...
	Route::get('genres/delete/{id}', 'GenresController@delete');
 	...
 	Route::get('originals', 'MoviesController@movies_list');	
	...
	Route::get('short_film_category', 'SportsCategoryController@category_list');	
	...
	Route::get('short_film', 'SportsController@sports_video_list');	
	...
	Route::get('regional_category', 'TvCategoryController@category_list');	
	...
	Route::get('regional', 'LiveTvController@live_tv_list');	
...
Route::get('originals', 'MoviesController@movies');
Route::get('movies/latest', 'MoviesController@movies_latest');
Route::get('movies/popular', 'MoviesController@movies_popular');
Route::get('originals/{slug}/{id}', 'MoviesController@movies_single')->name('movies_single');

Route::get('short-films', 'SportsController@sports');
Route::get('sports/{slug}', 'SportsController@sports_by_category');
Route::get('short-films/{slug}/{id}', 'SportsController@sports_single')->name('sports_single');

Route::get('regional', 'LiveTvController@live_tv_list');
Route::get('regional/{slug}', 'LiveTvController@live_tv_by_category');
Route::get('regional/{slug}/{id}', 'LiveTvController@live_tv_single')->name('tv_single');
