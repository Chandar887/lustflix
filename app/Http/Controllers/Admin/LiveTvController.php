...
class LiveTvController extends MainAdminController
{
    ...
    { 
        ...
        $page_title=trans('words.regional_vid');
    ...
    public function addTv()    { 
        ...
        $page_title=trans('words.add_regional');
    ...
    { 
        ...
        if(!empty($inputs['id'])){
         ...
         else if($inputs['channel_url_type']=="dash")
         {
          ...
          else if($inputs['channel_url_type']=="local"){
            $tv_obj->channel_url=$inputs['channel_url_local'];
          }
         else
         { 
    ...
    {      
          ...
          $page_title=trans('words.edit_regional');
