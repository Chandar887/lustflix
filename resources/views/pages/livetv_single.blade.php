        ...
        <div class="row">
          <div class="col-xs-12">            
            ...
            @if($tv_info->channel_url_type=="embed")
              ...
              @elseif($tv_info->channel_url_type=="local")
              <div id="container">                   
              <video id="v_player" class="video-js vjs-big-play-centered skin-blue vjs-16-9" controls preload="auto" playsinline crossorigin="anonymous" width="640" height="450" poster="{{URL::to('upload/source/'.$tv_info->channel_thumb)}}" data-setup="{}" @if(get_player_cong('autoplay')=="true")autoplay="true"@endif>
                  ...
                  <source src="{{'upload/source/'.$tv_info->channel_url2}}"   type="video/mp4" /> 
                  @elseif(isset($_GET['server']) AND $_GET['server']==3)
                  <source src="{{'upload/source/'.$tv_info->channel_url3}}"   type="video/mp4" /> 
                  @else
                  <source src="{{URL::to('upload/source/'.$tv_info->channel_url)}}"  type="video/mp4" /> 
            ...
            @elseif($tv_info->channel_url_type=="hls")
              ...
              <video id="v_player" class="video-js vjs-big-play-centered skin-blue vjs-16-9" controls preload="auto" playsinline crossorigin="anonymous" width="640" height="450" poster="{{URL::to('upload/source/'.$tv_info->channel_thumb)}}" data-setup="{}" @if(get_player_cong('autoplay')=="true")autoplay="true"@endif>
                  ...
                  <!-- video source -->
                  @if(isset($_GET['server']) AND $_GET['server']==2)
                  <source src="{{$tv_info->channel_url2}}" type="application/x-mpegURL"  type="video/mp4" / > 
                  @elseif(isset($_GET['server']) AND $_GET['server']==3)
                  <source src="{{$tv_info->channel_url3}}" type="application/x-mpegURL"  type="video/mp4" /> 
                  @else
                  <source src="{{$tv_info->channel_url}}" type="application/x-mpegURL" type="video/mp4" /> 
