...
@section('head_title', $tv_cat_info->category_name.' '.trans('words.regional').' | '.getcong('site_name') )
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 prs_upcom_slide_first">
                  <div class="prs_upcom_movie_box_wrapper prs_mcc_movie_box_wrapper">
                    <div class="prs_upcom_movie_img_box">
                      <img src="{{URL::to('upload/source/'.$live_tv_data->channel_thumb)}}" alt="{{$live_tv_data->channel_name}}" />@if($live_tv_data->video_access=='Paid')<span class="premium_video"><i class="fa fa-lock"></i>Premium</span>@endif
                      ...
                      <div class="prs_upcom_movie_img_btn_wrapper">
                        <ul>
                          ...
                          <li>
                            ...
                            @if(Auth::check())  
                            <a class="icon test-popup-link" href="{{ URL::to('regional/'.$live_tv_data->channel_slug.'/'.$live_tv_data->id) }}"><i class="flaticon-play-button"></i></a> 
                            
                            @else
                            @if($live_tv_data->video_access=='Paid')
                           ...
                           @else
                           <a class="icon test-popup-link" href="{{ URL::to('regional/'.$live_tv_data->channel_name.'/'.$live_tv_data->id) }}"><i class="flaticon-play-button"></i></a>
                            @endif  
                            @endif
                            </li>
