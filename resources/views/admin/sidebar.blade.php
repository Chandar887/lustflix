      ...
      <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
          ...
          <ul>
            ...
            <li><a href="{{ URL::to('admin/originals') }}" class="waves-effect {{classActivePath('movies')}}"><i class="fa fa-video-camera"></i> <span> {{trans('words.original')}}</span></a></li>
            <?php 
            ...
            ?>
            <li class="has_sub"> 
              <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-film"></i><span>{{trans('words.series')}} </span> <span class="menu-arrow"></span></a>
            ...
            <li class="has_sub"> 
              <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-tv"></i><span>{{trans('words.short_films')}} </span> <span class="menu-arrow"></span></a>
              <ul class="list-unstyled">                 
                <li class="{{classActivePath('sports_category')}}"><a href="{{ URL::to('admin/short_film_category') }}" class="{{classActivePath('sports_category')}}"><i class="fa fa-tags"></i> <span> {{trans('words.short_films_cat')}}</span></a></li>
                <li class="{{classActivePath('sports')}}"><a href="{{ URL::to('admin/short_film') }}" class="{{classActivePath('sports')}}"><i class="fa fa-list"></i> <span> {{trans('words.short_films_vid')}}</span></a></li>
               </ul>
            </li>
          <li class="has_sub"> 
              <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-globe"></i><span>{{trans('words.regional')}}</span> <span class="menu-arrow"></span></a>
              <ul class="list-unstyled">                 
                {{-- <li class="{{classActivePath('tv_category')}}"><a href="{{ URL::to('admin/regional_category') }}" class="{{classActivePath('tv_category')}}"><i class="fa fa-tags"></i> <span> {{trans('words.regional_cat')}}</span></a></li> --}}
                <li class="{{classActivePath('live_tv')}}"><a href="{{ URL::to('admin/regional') }}" class="{{classActivePath('live_tv')}}"><i class="fa fa-list"></i> <span> {{trans('words.regional_vid')}}</span></a></li>
               </ul>
            </li> 
            ...
            <li><a href="{{ URL::to('admin/originals') }}" class="waves-effect {{classActivePath('movies')}}"><i class="fa fa-video-camera"></i> <span> {{trans('words.movies_text')}}</span></a></li>
            <?php 
             // echo classActivePathSub('episodes');
             // exit;
