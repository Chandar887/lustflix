          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card-box">
                   ...
                   <div class="row">
                     <div class="col-sm-6">
                          <a href="{{ URL::to('admin/originals') }}"><h4 class="header-title m-t-0 m-b-30 text-primary pull-left" style="font-size: 20px;"><i class="fa fa-arrow-left"></i> {{trans('words.back')}}</h4></a>
                     </div>
                     @if(isset($movie->id))
                     <div class="col-sm-6">
                        <a href="{{ URL::to('originals/'.$movie->video_slug.'/'.$movie->id) }}" target="_blank"><h4 class="header-title m-t-0 m-b-30 text-primary pull-right" style="font-size: 20px;">{{trans('words.preview')}} <i class="fa fa-eye"></i></h4> </a>
                     </div>
                     @endif
                   </div> 
                ...
                @endif
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6"> 
                      <h4 class="m-t-0 m-b-30 header-title" style="font-size: 20px;">{{trans('words.original_info')}}</h4>  
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.original_access')}}</label>
                      <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.original_name')}}*</label>
                    <div class="col-sm-8">
                ...
                <div class="col-md-6"> 
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.original_thumbnail')}}* <small id="emailHelp" class="form-text text-muted">({{trans('words.recommended_resolution')}} : 270X390)</small></label>
                    <div class="col-sm-8">
                      <div class="input-group">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.original_poster')}} <small id="emailHelp" class="form-text text-muted">({{trans('words.recommended_resolution')}} : 650x350)</small></label>
                    <div class="col-sm-8">
                      <div class="input-group">
