          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="col-md-3">
                  <a href="{{URL::to('admin/live_tv/add_live_tv')}}" class="btn btn-success btn-md waves-effect waves-light m-b-20" data-toggle="tooltip" title="{{trans('words.add_regional')}}"><i class="fa fa-plus"></i> {{trans('words.add_regional')}}</a>
                </div>
              </div>
