          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                     <div class="col-sm-6">
                          <a href="{{ URL::to('admin/short_film') }}"><h4 class="header-title m-t-0 m-b-30 text-primary pull-left" style="font-size: 20px;"><i class="fa fa-arrow-left"></i> {{trans('words.back')}}</h4></a>
                     </div>
                     @if(isset($video_info->id))
                     <div class="col-sm-6">
                        <a href="{{ URL::to('short-films/'.$video_info->video_slug.'/'.$video_info->id) }}" target="_blank"><h4 class="header-title m-t-0 m-b-30 text-primary pull-right" style="font-size: 20px;">{{trans('words.preview')}} <i class="fa fa-eye"></i></h4> </a>
                     </div>
                     @endif
                   </div>
                ...
                @endif
                 ...
                 {!! Form::open(array('url' => array('admin/sports/add_edit_video'),'class'=>'form-horizontal','name'=>'video_form','id'=>'video_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="col-md-6">
                    <h4 class="m-t-0 m-b-30 header-title" style="font-size: 20px;">{{trans('words.short_film_info')}}</h4> 

                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.short_film_access')}}</label>
                      <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.short_film_cat')}}</label>
                      <div class="col-sm-8">
