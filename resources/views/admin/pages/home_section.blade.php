                ...
                @endif
                 ...
                 {!! Form::open(array('url' => array('admin/home_section'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.section_1_originals')}}*</label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.section_2_webseries')}}*</label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.section6_short_films')}}*</label>
                    <div class="col-sm-8">
                      <select name="section6_short_films[]" class="select2 select2-multiple" multiple="multiple" multiple data-placeholder="Select Video...">
                                 @foreach($short_film_list as $short_film)
                                 {{$short_film}};
                                 die;
                                  <option value="{{$short_film->id}}" @if(in_array($short_film->id, explode(",",$home_settings->section6_short_films))) selected @endif>{{$short_film->video_title}}</option>
                                @endforeach
                            </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.section7_regional')}}*</label>
                    <div class="col-sm-8">
                      <select name="section7_regional[]" class="select2 select2-multiple" multiple="multiple" multiple data-placeholder="Select Video...">
                                 @foreach($regional_list as $regional_data)
                                  <option value="{{$regional_data->id}}" @if(in_array($regional_data->id, explode(",",$home_settings->section7_regional))) selected @endif>{{$regional_data->channel_name}}</option>
                                @endforeach
                            </select>
                    </div>
                  </div>
                    ...
                    <label class="col-sm-3 col-form-label">{{trans('words.type')}}*</label>
                      <div class="col-sm-8">
                            <select class="form-control" name="section3_type">
                                <option value="Movie" @if(isset($home_settings->section3_type) AND $home_settings->section3_type=='Movie') selected @endif>Originals</option>
                    ...
                    <label class="col-sm-3 col-form-label">{{trans('words.type')}}*</label>
                      <div class="col-sm-8">
                            <select class="form-control" name="section4_type">
                                <option value="Movie" @if(isset($home_settings->section4_type) AND $home_settings->section4_type=='Movie') selected @endif>Originals</option>
                    ...
                    <label class="col-sm-3 col-form-label">{{trans('words.type')}}*</label>
                      <div class="col-sm-8">
                            <select class="form-control" name="section5_type">
                                <option value="Movie" @if(isset($home_settings->section5_type) AND $home_settings->section5_type=='Movie') selected @endif>Originals</option>
