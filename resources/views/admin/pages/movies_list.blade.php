          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="col-md-3">
                  <a href="{{URL::to('admin/movies/add_movie')}}" class="btn btn-success btn-md waves-effect waves-light m-b-20" data-toggle="tooltip" title="{{trans('words.add_originals')}}"><i class="fa fa-plus"></i> {{trans('words.add_original')}}</a>
                </div>
              </div>
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th>{{trans('words.poster')}}</th>
                      <th>{{trans('words.access')}}</th>
