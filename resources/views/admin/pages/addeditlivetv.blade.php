          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                     <div class="col-sm-6">
                          <a href="{{ URL::to('admin/regional') }}"><h4 class="header-title m-t-0 m-b-30 text-primary pull-left" style="font-size: 20px;"><i class="fa fa-arrow-left"></i> {{trans('words.back')}}</h4></a>
                     </div>
                     @if(isset($tv_info->id))
                     <div class="col-sm-6">
                        <a href="{{ URL::to('regional/'.$tv_info->channel_slug.'/'.$tv_info->id) }}" target="_blank"><h4 class="header-title m-t-0 m-b-30 text-primary pull-right" style="font-size: 20px;">{{trans('words.preview')}} <i class="fa fa-eye"></i></h4> </a>
                     </div>
                     @endif
                   </div>
                ...
                @endif
                 ...
                 {!! Form::open(array('url' => array('admin/live_tv/add_edit_live_tv'),'class'=>'form-horizontal','name'=>'video_form','id'=>'video_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="col-md-6">
                    <h4 class="m-t-0 m-b-30 header-title" style="font-size: 20px;">{{trans('words.regional_info')}}</h4> 

                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.regional_access')}}</label>
                      <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.regional_category')}}*</label>
                      <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.regional_name')}}*</label>
                    <div class="col-sm-8">
                ...
                <div class="col-md-6">
                    ...
                    <label class="col-sm-3 col-form-label">{{trans('words.live_tv_stream_type')}} </label>
                      <div class="col-sm-8">
                            ...
                            <option value="local" @if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type=="local") selected @endif>Local</option>
                ...
                <div class="form-group row" id="local_url_id" @if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type!="local") style="display:none;" @endif>
                  <label class="col-sm-3 col-form-label">{{trans('words.video_file')}}*</label>
                  <div class="col-sm-8">
                      <div class="input-group">

                        <input type="text" name="channel_url_local" id="local_channel" value="{{ isset($tv_info->channel_url) ? $tv_info->channel_url : null }}" class="form-control" readonly>
                  ...
                  <div class="form-group row" id="live_embed_id" @if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type!="embed") style="display:none;" @endif @if(!isset($tv_info->channel_url_type)) style="display:none;" @endif>
                    <label class="col-sm-3 col-form-label">{{trans('words.embed_code')}}*</label>
                     <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-8">                         
                        ...
                        <p id="local_stream_id" @if(!isset($tv_info->channel_url_type)) style="display:none;" @endif @if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type!="local") style="display:none;" @endif><small id="emailHelp" class="form-text text-muted">Supported Local Video </small></p>
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.regional_logo')}}* <small id="emailHelp" class="form-text text-muted">({{trans('words.recommended_resolution')}} : 650x350)</small></label>
                    <div class="col-sm-8">
                      <div class="input-group">
    ...
    <div class="modal-dialog modal-lg" style="max-width: 900px;">
        <div class="modal-content">             
            <div class="modal-body">
               ...
               <iframe src="{{URL::to('responsive_filemanager/filemanager/dialog.php?type=2&sort_by=date&field_id=local_channel&relative_url=1')}}" frameborder="0"></iframe>
               </div>
            </div>
        </div> 
    </div> 
